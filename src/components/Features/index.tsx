    ...
    >
      ...
      <div className="container-responsive relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          {/* Feature 1 */}
          <div className="bg-white/10 border border-white/10 rounded-2xl md:rounded-3xl p-6 md:p-8 flex flex-col lg:flex-row gap-6 md:gap-8 items-center group hover:bg-white/15 transition-all duration-300 animate-fade-in-left animate-delay-300 hover-lift">
          ...
          {/* Feature 2 */}
          <div className="bg-white/10 border border-white/10 rounded-2xl md:rounded-3xl p-6 md:p-8 flex flex-col gap-4 md:gap-6 group hover:bg-white/15 transition-all duration-300 animate-fade-in-right animate-delay-400 hover-lift">
            <div className="bg-white/10 border border-white/20 rounded-xl md:rounded-2xl w-12 h-12 md:w-14 md:h-14 flex items-center justify-center">
              <ImageUploadIcon className="w-6 h-6 md:w-7 md:h-7 text-white" />
            </div>
            <div className="flex flex-col gap-3 md:gap-4">
          ...
          {/* Feature 3 */}
          <div className="bg-white/10 border border-white/10 rounded-2xl md:rounded-3xl p-6 md:p-8 flex flex-col gap-4 md:gap-6 group hover:bg-white/15 transition-all duration-300 animate-fade-in-left animate-delay-500 hover-lift">
            <div className="bg-white/10 border border-white/20 rounded-xl md:rounded-2xl w-12 h-12 md:w-14 md:h-14 flex items-center justify-center">
              <ImageUploadIcon className="w-6 h-6 md:w-7 md:h-7 text-white" />
            </div>
            <div className="flex flex-col gap-3 md:gap-4">
