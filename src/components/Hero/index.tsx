...
const Hero: React.FC<HeroProps> = ({ onOpenPlayground }) => {
  return (
    <section className="relative bg-[#000319] min-h-screen flex items-center justify-center overflow-hidden w-full max-w-full">
      ...
      <div className="container-responsive">
        <div className="relative z-10 flex flex-col items-center gap-6 md:gap-8 lg:gap-10 max-w-4xl mx-auto text-center">
          {/* Trust Badge */}
